...
from dtwin.infosystem.objects.simulation.obj import ProcessInstance
from dtwin.infosystem.process.control_flow import factory as control_flow_factory
from dtwin.infosystem.process.activity.obj import ActivityRepository
from dtwin.infosystem.utils.logging import record_process_instance, record_event
from dtwin.infosystem.process.config import factory as config_factory


RANDOM_SEED = 42
T_INTER = 6     # Create a car every ~7 minutes
SIM_TIME = 24*30    # Simulation time in minutes
...
file_name = "../logs/simulated-logs.jsonocel"
