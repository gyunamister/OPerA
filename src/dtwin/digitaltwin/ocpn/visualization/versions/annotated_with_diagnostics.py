...
from dtwin.digitaltwin.diagnostics.util import equal_arc
...
def apply(ocpn, diagnostics, parameters=None):
    ...
    for pl in ocpn.places:
        ...
        if pl.initial == True:
            g.node(this_uuid, pl.name, shape="circle", style="filled", fillcolor=color, color=color,
                   fontsize="13.0", labelfontsize="13.0")
        elif pl.final == True:
            g.node(this_uuid, pl.name, shape="circle", style="filled", color=color, fillcolor=color,
                   fontsize="13.0", labelfontsize="13.0")
        else:
            g.node(this_uuid, pl.name, shape="circle", color=color,
                   fontsize="13.0", labelfontsize="13.0")
