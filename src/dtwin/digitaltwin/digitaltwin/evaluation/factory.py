...
from dtwin.util.util import DIAGNOSTICS_MAP, OPS_MAP, DIAGNOSTICS_FILTER_MAP
...
def evaluate(action_pattern_repo, dt, event_df, current_timestamp, interval, n_intervals):
    ...
    for ap in action_pattern_repo:
        ...
        if trigger:
            action_message = execute_action(ap["action"])
        else:
...
def execute_action(action):
    ...
    config_factory.update_config(valve, value)
