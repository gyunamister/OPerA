...
from dtwin.available.available import AvailableSelections, AvailableNormRanges
from dtwin.available.constants import TRANSFORMATION_KEY


class DtwinExtensible(Enum):
    CORR = 'correlation'


class DtwinExtension:
    """A generic class for extensible objects of dtwin.
...
- typ: An instance of DtwinExtensible.
