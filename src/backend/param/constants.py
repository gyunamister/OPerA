...
STORES_SIGNALS = [HOME_TITLE, CVIEW_TITLE, DVIEW_TITLE, DASHBOARD_TITLE, PATTERN_TITLE, CORR_TITLE, CORR_OUT_TITLE, TRACE_TITLE, DEV_CTX_TITLE, RESULT_TITLE, GUIDANCE_TITLE, RESULT_INIT,
